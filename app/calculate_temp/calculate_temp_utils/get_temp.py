...
class AbstractGetTemp(ABC):
    @abstractmethod
    def user_in_midday_period(self):
        pass

    @abstractmethod
    def user_in_night_period(self):
        pass

    @abstractmethod
    def user_in_morning_twilight(self, sun_times):
        pass

    @abstractmethod
    def user_in_night_twilight(self, sun_times):
        pass

    def get_temp(self, sun_times):
        if (
